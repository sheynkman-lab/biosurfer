...
pfam_dom_names = 'gencode/pfamA.tsv'
...
DB_GENCODE.load_translation_fasta(path + gencode_tl, get_ids_from_gencode_fasta, skip_par_y)
DB_GENCODE.load_domain_mappings(path + gencode_doms, path + pfam_dom_names)
end = time()
