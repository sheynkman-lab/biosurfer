...
pacbio_gtf = 'smc/SMC_with_cds.gtf'
orf_tsv = 'smc/SMC_best_orf.tsv' 
pacbio_tx = 'smc/SMC_corrected.fasta'
pacbio_tl = 'smc/SMC_orf_refined.fasta'
sqanti = 'smc/SMC_classification.txt'
